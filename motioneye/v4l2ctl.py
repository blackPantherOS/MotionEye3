...
def find_v4l2_ctl():
    try:
        ctl = subprocess.check_output(['which', 'v4l2-ctl'], stderr=utils.DEV_NULL).strip()
        ctl = ctl.decode('utf-8')
        return ctl
...
def list_devices():
    ...
    try:
        ...
        fd = p.stdout.fileno()
        # itt python3-ban 19 az eredménye az fd-nek python2-ben 16
        fl = fcntl.fcntl(fd, fcntl.F_GETFL)
        # ez nulla mindkét python-ban
